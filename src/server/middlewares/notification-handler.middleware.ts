...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'healthcare_provider.update': {
    ...
    tenantPath: ['organization', 'user', 'healthcare_provider'],
    userPath: [],
  },
  'medical_staff.update': {
    roles: ['system-administrator', 'medical-staff'],
    key: 'medical-staff-patient-profile-update',
    tenantPath: ['organization', 'user', 'medical_staff'],
    userPath: [],
  },
  'guest.update': {
    roles: ['system-administrator', 'healthcare-provider', 'medical-staff'],
    key: 'guest-appointment-booking-update',
