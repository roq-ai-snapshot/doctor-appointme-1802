  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="is your reliable partner in managing and scheduling medical appointments with ease and precision."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`is your reliable partner in managing and scheduling medical appointments with ease and precision.`}
            </Text>
            <Box
